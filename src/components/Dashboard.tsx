        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#1C201C] rounded-2xl border border-[#DDDDD6] dark:border-[#333A33] p-8 shadow-sm text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                onClick={openAddSkillModal}
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 dark:bg-emerald-700 dark:hover:bg-emerald-800 text-white text-xs sm:text-sm font-semibold shadow-md shadow-emerald-600/20 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
            ...
            <div className="lg:col-span-4 bg-white dark:bg-[#1C201C] rounded-2xl border border-[#DDDDD6] dark:border-[#333A33] p-6 shadow-sm flex flex-col justify-between h-full group hover:border-emerald-500/40 transition-colors">
                ...
                <div className="my-6 flex justify-center">
                  {featuredSkill.goal ? (
                    ...
                    <div className="w-32 h-32 rounded-full border-4 border-emerald-500/20 dark:border-emerald-500/30 flex flex-col items-center justify-center text-center p-2">
                      ...
                      <span className="text-[10px] text-[#5F6A5F] dark:text-[#A0AAA0]">total hours</span>
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-[#DDDDD6] dark:border-[#262B26]">
                ...
                <button
                  ...
                  className="flex-1 py-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 dark:bg-emerald-700 dark:hover:bg-emerald-800 text-white text-xs font-semibold shadow-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
                  <Plus className="w-3.5 h-3.5" />
                ...
                <button
                  onClick={() => setSelectedSkillId(featuredSkill.id)}
                  className="p-2 rounded-xl border border-[#DDDDD6] dark:border-[#333A33] hover:bg-[#F2F2EE] dark:hover:bg-[#262B26] text-[#5F6A5F] dark:text-[#A0AAA0] transition-colors cursor-pointer"
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <ChevronRight className="w-3.5 h-3.5 text-[#5F6A5F] dark:text-[#A0AAA0] opacity-0 group-hover:opacity-100 transition-opacity" />
                      </div>
                    ...
                    {skill.goal && stats && stats.goalProgressPercent !== null && (
                      <div className="mt-3 pt-2 border-t border-[#E8E8E2] dark:border-[#262B26]">
                        <div className="flex items-center justify-between text-[10px] text-[#5F6A5F] dark:text-[#A0AAA0] mb-1">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0 text-right">
                      <div>
                        ...
                        <span className="text-[10px] text-[#5F6A5F] dark:text-[#A0AAA0] block">
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className="p-1 rounded text-[#5F6A5F] dark:text-[#A0AAA0] hover:bg-[#E8E8E3] dark:hover:bg-[#262B26] hover:text-[#1A1D1A] cursor-pointer"
                          title="Edit Session"
                        >
                        ...
                        <button
                          ...
                          className="p-1 rounded text-[#5F6A5F] dark:text-[#A0AAA0] hover:bg-red-50 dark:hover:bg-red-950/40 hover:text-red-600 cursor-pointer"
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#1C201C] rounded-2xl border border-[#DDDDD6] dark:border-[#333A33] p-6 shadow-sm">
          <div className="flex items-center justify-between pb-3 mb-4 border-b border-[#DDDDD6] dark:border-[#262B26]">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-[#5F6A5F] dark:text-[#A0AAA0] hover:bg-[#F2F2EE] dark:hover:bg-[#262B26] transition-colors cursor-pointer disabled:opacity-50"
