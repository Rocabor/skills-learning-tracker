      ...
      <div className="relative w-full max-w-lg rounded-2xl bg-white dark:bg-[#1C201C] border border-[#DDDDD6] dark:border-[#333A33] shadow-2xl p-6 text-[#1A1D1A] dark:text-[#ECF0EC] z-10">
            ...
            <button
              ...
              className={`px-3 py-1 text-xs font-medium rounded-lg transition-all cursor-pointer ${
                cardTheme === 'dark'
                  ...
                  : 'text-[#5F6A5F] dark:text-[#A0AAA0] hover:text-[#1A1D1A]'
              }`}
            >
              Dark Minimal
            </button>
        ...
        <div className="flex items-center justify-end gap-3 mt-5 pt-3 border-t border-[#DDDDD6] dark:border-[#262B26]">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-5 py-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 dark:bg-emerald-700 dark:hover:bg-emerald-800 text-white text-xs font-semibold shadow-md shadow-emerald-600/20 active:scale-95 transition-all cursor-pointer"
          >
