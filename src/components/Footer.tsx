...
export const Footer: React.FC = () => {
  return (
    <footer
      id="app-footer"
      className="border-t border-[#DDDDD6] dark:border-[#262B26] bg-transparent py-6 text-center text-xs text-[#5F6A5F] dark:text-[#A0AAA0] mt-12 transition-colors duration-200"
    >
